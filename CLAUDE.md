# azurelocal-sql-mi — Claude Code Context
...
- `azurelocal-sql-mi-engineer` (model: sonnet) — Expert in `azurelocal-sql-mi`: deep knowledge of this repo's structure, conventions, and development workflow.
